...
open class AK___VARIABLE_nodeName___: AKNode, AKToggleable, AKComponent, AKInput {
    public typealias AKAudioUnitType = AK___VARIABLE_nodeName___AudioUnit
    /// Four letter unique description of the node
    public static let ComponentDescription = AudioComponentDescription(effect: "___VARIABLE_componentCode___")
